...
public class TravelController {
  ...
  @PostMapping
  public ResponseEntity<TravelContracts.Response> create(
      @Valid @RequestBody TravelContracts.CreateRequest request, @AuthenticationPrincipal Jwt jwt) {
  ...
  public TravelContracts.Response update(
      ...
      @Valid @RequestBody TravelContracts.UpdateRequest request,
