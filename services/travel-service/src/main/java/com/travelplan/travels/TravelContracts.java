...
public final class TravelContracts {
    ...
    public record CreateRequest(
        ...
        public CreateRequest(String destination, String dates, Integer durationDays, String activities,
                             String accommodation, String transportation) {
            this(destination, dates, durationDays, activities, accommodation, transportation, null, null, null, null);
        }
    }
    ...
    public record UpdateRequest(
        ...
        public UpdateRequest(String destination, String dates, Integer durationDays, String activities,
                             String accommodation, String transportation) {
            this(destination, dates, durationDays, activities, accommodation, transportation, null, null, null, null, null);
        }
    }
    ...
    public record Response(UUID id, String destination, String dates, int durationDays,
                           ...
                           UUID managerId, LocalDate startDate, LocalDate endDate, BigDecimal price,
        ...
        static Response from(Travel travel) {
            return new Response(travel.getId(), travel.getDestination(), travel.getDates(),
                    ...
                    travel.getTransportation(), travel.getManagerId(), travel.getStartDate(), travel.getEndDate(),
                    travel.getPrice(), travel.getCapacity(), travel.getStatus(), travel.getCreatedAt(), travel.getUpdatedAt());
        }
    }
}
